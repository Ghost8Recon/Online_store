...
class Order(models.Model):
    ...
    total_price = models.DecimalField(max_digits=10, decimal_places=2, default=0) #total_price for all product in order
    ...
    custumer_address = models.CharField(max_length=128, blank=True, null=True, default=None)
